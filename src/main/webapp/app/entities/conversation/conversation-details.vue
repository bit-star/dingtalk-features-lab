    ...
    <div class="col-8">
      <div v-if="conversation">
        <h2 class="jh-entity-heading" data-cy="conversationDetailsHeading">
          <span v-text="$t('dingtalkFeaturesLabApp.conversation.detail.title')">Conversation</span> {{ conversation.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="$t('dingtalkFeaturesLabApp.conversation.name')">Name</span>
          </dt>
          <dd>
